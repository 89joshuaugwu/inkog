...
export default function ProfilePage() {
  ...
  async function handleSendMessage(e: React.FormEvent) {
    ...
    try {
      ...
      // Push real-time notification to RTDB
      try {
        ...
        // RTDB notification is non-critical — don't block the send
      }
  ...
  if (notFound) {
    return (
      <div
        ...
        style={{ backgroundColor: "#0A0A0A" }}
      >
        <div style={{ fontSize: "80px", opacity: 0.5, marginBottom: "24px" }}>
          👻
        </div>
        <h1
        ...
        <div className="w-full max-w-lg">
          ...
          <div className="text-center mb-8">
            {profile?.photoURL ? (
              ...
              <div
                className="mx-auto mb-4 flex items-center justify-center font-display font-bold text-white text-2xl"
                style={{
                  width: "80px",
                  height: "80px",
                  borderRadius: "50%",
            ...
            {profile?.bio && (
              <p
                className="font-body text-sm mt-3 max-w-sm mx-auto"
                style={{ color: "rgba(255,255,255,0.7)", lineHeight: "22px" }}
              >
                {profile.bio}
              </p>
            )}
          ...
          {sent ? (
            ...
            >
              ...
              <div className="flex flex-col gap-3 items-center">
                ...
                <Link
                  href="/login"
                  className="font-body text-xs no-underline transition-colors duration-150"
                  style={{ color: "#8B5CF6" }}
                >
            ...
            <form onSubmit={handleSendMessage}>
              ...
              >
                <label
                  className="font-body text-sm font-bold block mb-3"
                  style={{ color: "#0A0A0A" }}
                >
                ...
                <div className="relative">
                  <textarea
                    ...
                    onFocus={(e) => {
                      ...
                      e.currentTarget.style.boxShadow =
                        "0px 0px 0px 4px rgba(139,92,246,0.15)";
                    }}
                    onBlur={(e) => {
                  ...
                  />
                  <span
                    className="absolute bottom-3 right-4 font-body text-xs"
                    style={{ color: "#6B7280" }}
                  >
                    {charCount}/{MAX_CHARS}
                  </span>
              ...
              <p
                ...
                style={{ color: "#6B7280" }}
              >
                🔒 Your identity is completely hidden. We don&apos;t track or
                store any sender info.
              </p>
            </form>
          )}
        </div>
